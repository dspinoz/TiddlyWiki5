 ...
 */
//ds change: added parameters for tiddly wiki
(function(d3,crossfilter) {
...
return dc;
  ...
  /*
  //ds change: disabled for tiddlywiki
    if(typeof define === "function" && define.amd) {
        console.log("AMD");
        define(["d3", "crossfilter"], _dc);
    }
    else if(typeof module === "object" && module.exports) {
        console.log("MODULE",module,module.exports);var _d3 = require('d3');
        ...
        console.log("ELSE",d3,crossfilter);
        this.dc = _dc(d3, crossfilter);
    }
    //this.dc = _dc(d3, crossfilter);
    */
    // ds change: export function so can call when holding d3 and crossfilter
    module.exports = _dc;
}
)();
